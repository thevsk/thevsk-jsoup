...
public class SQLiteKit {
    ...
    public SQLiteKit(String filePath) throws Exception {
    ...
    public static void main(String[] args) {
        try {
            SQLiteKit sqLite = new SQLiteKit(JettyStart.getStartPath() + JettyStart.separator + "test.db");
